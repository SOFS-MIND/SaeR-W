        ...
        <section class="content-header">
         ...
         <?php 
			...
			if($_REQUEST[product_name])
			{
				...
				$whereproduct= "and product_name ='".$_REQUEST[product_name]."'";
     		}
			if($_REQUEST[size])
			{
				$wheresize= "and size ='".$_REQUEST[size]."'";
     		}
			...
			{
            global $database, $db;
            $qry="SELECT * from `".TBL_COMMEN_PRODUCT_STOCK."` where req_status = 0 $whereproduct $wheresize $wherematerial ORDER BY
                   id ASC";  
				   //print_r($qry);
				   //exit;
			...
			elseif( $seresh == "")
			{
				$qry="SELECT * from `".TBL_COMMEN_PRODUCT_STOCK."` where product_name = 'ROD'";
				$result = $database->query( $qry );
			}
            ?>
          ...
          <div class="box">
            <div class="box">
                <div class="box-header">
				  ...
				  <a href="rod.php" class="btn btn-md btn-primary">Add stock</a>
                    ...
                    <tbody>
                       <?php 
                                        	...
                                        	<tr>
												...
												<td> <a href="rod.php?mode=required&id=<?php echo $row['id']; ?>">
                                                    <button class="btn btn-md bg-info">Required</button>
                                                </a></td>
                                                <td style="width:100px;">
                                                <a href="rod.php?mode=edit&id=<?php echo $row['id']; ?>">
