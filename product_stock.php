        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box">
                ...
                <div class="box-body">
                  <form role="form" action="product_stock_action.php" id="stock" enctype="multipart/form-data" method="post">
                  <?php if($_GET['mode'] == "") {?>
				                    ...
				                    <div class="row">
                                     <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="product_name" name="product_name" value="<?php echo $row['product_name'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?>>
                                        </div>
								     </div>
