      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
         ...
         <?php 
			...
			if($_GET[rid] == "")
			{
            $qry="SELECT * from `".TBL_STOCK."` as stk LEFT JOIN  `".TBL_REQUIRED."` as ret on stk.id=ret.stock_IDFK where stk.id=".$_GET['id']."";
			}
			else{
			 $qry="SELECT * from `".TBL_STOCK."` as stk LEFT JOIN  `".TBL_REQUIRED."` as ret on stk.id=ret.stock_IDFK where stk.id=".$_GET['id']." AND ret.id=".$_GET['rid']."";
			}
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box">
                ...
                <div class="box-body">
                  <form role="form" action="stock_action.php" id="stock" enctype="multipart/form-data" method="post">
                  <?php if($_GET['mode'] == "") {?>
				                    ...
				                    <div class="row">
                                     <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="Patten number">Patten Number</label>
                                            <input type="text" class="form-control" id="pattern_no" name="pattern_no" value="<?php echo $row['pattern_no'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?>>
                                        </div>
								     </div>
				                    
				                        <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="Patten number">Part Name</label>
                                            <input type="text" class="form-control" id="part_name" name="part_name" value="<?php  echo $row['part_name'];  ?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?> >
                                        </div>
                                        </div>
									 </div>
									<div class="row">
                                     <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                            <label for="exampleInputFile">MOC</label>
                                             <input type="text" class="form-control" id="moc" name="moc" value="<?php echo $row['moc'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?> >
                                        </div>
                                        </div>
                                        <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                         <div class="form-group">
                                            <label for="exampleInputFile">Each Weight</label>
                                             <input type="text" class="form-control" id="e_wt" name="e_wt" value="<?php echo $row['e_weight'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?>>
                                        </div>
                                        </div>
	...
	<script>
        $().ready(function() {
        	...
        	$("#stock").validate({
		      ...
		      messages: {
		    	  pattern_no: {
						required: "Enter the patten number"
				        },
								  part_name: {
						required: "Enter the part name"
						 },
						moc: {
						required:"Enter the MOC"
						},
						quantity:
						{
