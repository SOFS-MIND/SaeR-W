        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box">
                ...
                <div class="box-body">
                  <form role="form" action="rod_action.php" id="stock" enctype="multipart/form-data" method="post">
                  <?php if($_GET['mode'] == "") {?>
				                    ...
				                    <div class="row">
                                     <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="product_name" name="product_name" value="ROD" readonly>
                                        </div>
								     </div>
                                     ...
                                     <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                            <label for="exampleInputFile">Material</label>
                                             <input type="text" class="form-control" id="material" name="material" value="<?php echo $row['material'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?> >
                                        </div>
                                        </div>
										<div class="col-md-6">
                                         <div class="form-group">
                                            <label for="exampleInputFile">Code No</label>
                                             <input type="text" class="form-control" id="code_no" name="code_no" value="<?php echo $row['code_no'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?>>
                                        </div>
                                        </div>
										 ...
										 <div class="row">
										  <div class="col-md-6">
                                       <div class="form-group">
                                            <label for="exampleInputFile">KGS</label>
                                             <input type="text" class="form-control" id="kgs" name="kgs" value="<?php echo $row['kgs'];?>" <?php if($_GET['mode'] == "required") { echo "readonly"; } ?>>
                                        </div>
										</div>
									  <div class="col-md-6">
                                       <div class="form-group">
        	...
        	$("#stock").validate({
		      ...
		      messages: {
		    	  product_name: {
						...
						material: {
						required:"Enter the material name"
						},
						quantity:
						{
