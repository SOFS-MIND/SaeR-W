...
<html>
  <head>
    ...
    <title>SAM ERP - Add new material</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Machine Management</a></li>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" name="pattern_no" id="pattern_no" />
						</div><!-- /.form-group -->
						<div class="form-group col-md-6">
							<label>Pos No</label>
							<input type="text" class="form-control" name="pos_no" id="pos_no" />
						</div><!-- /.form-group -->
						<div class="form-group col-md-6">
						...
						<div class="form-group col-md-6">
							...
							<input type="text" class="form-control" name="material_from" id="material_from" />
						</div><!-- /.form-group -->
						<div class="form-group col-md-6">
							<label>Material Specification</label>
							<input type="text" class="form-control" name="material_spec" id="material_spec" />
						</div><!-- /.form-group -->
						<div class="form-group col-md-6">
